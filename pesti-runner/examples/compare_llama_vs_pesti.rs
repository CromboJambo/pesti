...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let result_pesti = reference_with_ndarray(&q_h, &k_h, &v_h, seq_q, seq_k, num_heads, head_dim, rope_base, scale);
    ...
    #[cfg(feature = "llama-cpp")]
    {
        ...
        // Compare
        let max_error = result_pesti.iter()
    ...
    #[cfg(not(feature = "llama-cpp"))]
    {
        ...
        println!("  Run with: cargo run --package pesti-runner --example compare_llama_vs_pesti --features cuda,llama-cpp");
    }
    ...
    #[cfg(feature = "mistralrs")]
    {
        ...
        println!("  Output sample (first 5): [{:.4}, {:.4}, {:.4}, {:.4}, {:.4}]", 
                 result_mistral[0], result_mistral[1], result_mistral[2], result_mistral[3], result_mistral[4]);
    ...
    #[cfg(not(feature = "mistralrs"))]
    {
        ...
        println!("  Run with: cargo run --package pesti-runner --example compare_llama_vs_pesti --features cuda,mistralrs");
    }

    println!("\n=== Summary ===");
    println!("PESTI Ndarray: {:.3}ms (baseline)", duration_pesti.as_secs_f64() * 1000.0);
