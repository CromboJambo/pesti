//! Debug tokenizer JSON config output - compact version.
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Build merges list - but limit to first 10 for testing
